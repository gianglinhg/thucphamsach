<div class=" grid_columns section-category convert">
    <!--  -->
    <div class="swiper mySwipera category__slide">
        <div class="swiper-wrapper">
            <!-- PHẦN RENDER DANH SÁCH SẢN PHẨM BÁN CHẠY -->
            <?php
